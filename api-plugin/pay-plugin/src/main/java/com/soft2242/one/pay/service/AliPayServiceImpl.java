...
import com.soft2242.one.pay.config.AliPayConfig;
...
//    @GetMapping("/pay") // &subject=xxx&traceNo=xxx&totalAmount=xxx
    @Override
    public String pay(String traceNo, Double totalAmount, String subject, String alipayTraceNo, HttpServletResponse httpResponse) throws Exception {
